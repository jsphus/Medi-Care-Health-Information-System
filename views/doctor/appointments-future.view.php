...
<div class="page-header">
    ...
    <div style="display: flex; gap: 0.5rem; margin-top: 1.5rem; border-bottom: 2px solid var(--border-light);">
        ...
        <a href="/doctor/appointments/future" class="tab-link active" style="padding: 0.75rem 1.5rem; text-decoration: none; color: var(--primary-blue); font-weight: 600; border-bottom: 2px solid var(--primary-blue); margin-bottom: -2px; transition: all 0.2s; display: flex; align-items: center; gap: 0.5rem;">
            <i class="fas fa-calendar-check"></i>
            <span>Upcoming</span>
            <?php if (count($appointments) > 0): ?>
                <span class="badge" style="background: var(--status-success); color: white; padding: 0.125rem 0.5rem; border-radius: 10px; font-size: 0.75rem;"><?= count($appointments) ?></span>
            <?php endif; ?>
        </a>
