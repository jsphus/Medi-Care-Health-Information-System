...
<div class="account-container">
    <div class="account-header">
        ...
        <a href="/doctor/account" class="btn-cancel">
    ...
    if (!isset($doctor)) {
        ...
        echo '<strong>DEBUG:</strong> $doctor is not set';
        echo '</div>';
    } elseif (!is_array($doctor)) {
        echo '<div style="background: #fee2e2; padding: 1rem; margin-bottom: 1rem; border-radius: 8px;">';
        echo '<strong>DEBUG:</strong> $doctor is not an array. Type: ' . gettype($doctor);
        echo '</div>';
    } else {
        echo '<div style="background: #d1fae5; padding: 1rem; margin-bottom: 1rem; border-radius: 8px; font-size: 0.875rem;">';
        echo '<strong>DEBUG:</strong> Doctor data available. Keys: ' . implode(', ', array_keys($doctor)) . '<br>';
        echo 'Email: ' . ($doctor['doc_email'] ?? 'NULL') . '<br>';
        echo 'First Name: ' . ($doctor['doc_first_name'] ?? 'NULL');
        echo '</div>';
    }
    ?>
